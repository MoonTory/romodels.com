...
export function CategoryFilter({ children, onCategorySelect }) {
  ...
  return (
    <div>
      <ul style={{ marginBottom: '2rem' }} className='nav bg-primary nav-justify justify-content-center text-white'>
